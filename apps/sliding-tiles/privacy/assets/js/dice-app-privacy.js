(() => {
  ...
  const translations = {
    es: {
      title: 'Sliding Tiles Puzzle - Aviso de privacidad', intro: 'Este aviso explica cómo Sliding Tiles Puzzle trata la información en Android, Windows y la demo web. La mayor parte de los datos del juego permanece de forma local en el dispositivo o navegador de la persona usuaria.', language: 'Idioma', updated: 'Última actualización', updatedValue: '1 de septiembre de 2026', scopeValue: 'Aplica a las versiones para Android, Windows y demo web',
      ...
      contactTitle: 'Contacto', contactText: 'Para consultas relacionadas con Sliding Tiles Puzzle o este aviso, visita el catálogo oficial de Dice Labs.', contactLink: 'dice-labs.com/apps/', mainContactLabel: 'Correo principal:', technicalText: 'Contacto técnico:'
    },
    en: {
      title: 'Sliding Tiles Puzzle - Privacy notice', intro: 'This notice explains how Sliding Tiles Puzzle handles information on Android, Windows, and the web demo. Most game data stays locally on the user’s device or browser.', language: 'Language', updated: 'Last updated', updatedValue: 'September 1, 2026', scopeValue: 'Applies to Android, Windows, and web demo versions',
      ...
      contactTitle: 'Contact', contactText: 'For questions about Sliding Tiles Puzzle or this notice, visit the official Dice Labs catalog.', contactLink: 'dice-labs.com/apps/', mainContactLabel: 'Primary email:', technicalText: 'Technical contact:'
    },
    fr: {
      title: 'Sliding Tiles Puzzle - Avis de confidentialité', intro: 'Cet avis explique comment Sliding Tiles Puzzle traite les informations sur Android, Windows et la démo web. La plupart des données de jeu restent localement sur l’appareil ou le navigateur de la personne utilisatrice.', language: 'Langue', updated: 'Dernière mise à jour', updatedValue: '1er septembre 2026', scopeValue: 'S’applique aux versions Android, Windows et démo web',
      ...
      contactTitle: 'Contact', contactText: 'Pour toute question concernant Sliding Tiles Puzzle ou cet avis, consultez le catalogue officiel de Dice Labs.', contactLink: 'dice-labs.com/apps/', mainContactLabel: 'E-mail principal :', technicalText: 'Contact technique :'
    },
    de: {
      title: 'Sliding Tiles Puzzle - Datenschutzhinweis', intro: 'Dieser Hinweis erklärt, wie Sliding Tiles Puzzle Informationen unter Android, Windows und in der Web-Demo verarbeitet. Die meisten Spieldaten bleiben lokal auf dem Gerät oder im Browser der nutzenden Person.', language: 'Sprache', updated: 'Letzte Aktualisierung', updatedValue: '1. September 2026', scopeValue: 'Gilt für Android-, Windows- und Web-Demo-Versionen',
      ...
      contactTitle: 'Kontakt', contactText: 'Bei Fragen zu Sliding Tiles Puzzle oder diesem Hinweis besuchen Sie den offiziellen Dice-Labs-Katalog.', contactLink: 'dice-labs.com/apps/', mainContactLabel: 'Haupt-E-Mail:', technicalText: 'Technischer Kontakt:'
    },
    ru: {
      title: 'Sliding Tiles Puzzle - Уведомление о конфиденциальности', intro: 'Это уведомление объясняет, как Sliding Tiles Puzzle обрабатывает информацию в Android, Windows и веб-демо. Большая часть игровых данных хранится локально на устройстве или в браузере пользователя.', language: 'Язык', updated: 'Последнее обновление', updatedValue: '1 сентября 2026 г.', scopeValue: 'Применяется к версиям Android, Windows и веб-демо',
      ...
      contactTitle: 'Контакты', contactText: 'По вопросам о Sliding Tiles Puzzle или этом уведомлении посетите официальный каталог Dice Labs.', contactLink: 'dice-labs.com/apps/', mainContactLabel: 'Основной адрес эл. почты:', technicalText: 'Технический контакт:'
    }
  };
